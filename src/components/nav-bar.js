...
class NavBar extends LitElement {
  static styles = css`
    ...
    .link { color:var(--text); opacity:.9; padding:8px 10px; border-radius:10px; text-decoration:none; }
  ...
  render() {
    ...
    return html`
      ...
      <a class="link" href="/employees">${getIcon('users', '16')} ${t('nav.employees')}</a>
      <a class="link" href="/employees/new">${getIcon('userPlus', '16')} ${t('nav.addEmployee')}</a>
      <div class="actions">
